---
proposal_id: DNV-2025-IronMountain
client: Iron Mountain (Nederland) Data Centre B.V.
version: 1
date: 2025-12-08
valid_until: 2025-12-22
prepared_by: DNV Netherlands B.V.
status: draft
owner_action_required: true
project_type: grid_capacity_upgrade
---
...
Iron Mountain operates a critical data center facility in Haarlem. The site currently has a 30 MVA connection via Liander on the medium-voltage network and aims to move to a 70 MVA connection via TenneT. This request is made in a context of grid congestion in Noord-Holland, where standard capacity requests face significant delays and, in some cases, rejection. Without a differentiated technical proposal, Iron Mountain risks remaining on a waiting list for an extended period.
...
In this phase we review the existing 30 MVA connection, the desired 70 MVA connection at TenneT level and the reasons behind this request (capacity needs, timing, security of supply, commercial drivers). We also discuss what degree of operational flexibility Iron Mountain may be willing to consider, for example with respect to peak demand, temporary curtailment or the use of on‑site resources. The review includes available load and consumption data, basic connection documentation and the main elements of past correspondence with Liander and TenneT.

The outcome of Phase 1 is a concise description of Iron Mountain’s case: what is being requested, why it is needed, what flexibility is and is not acceptable, and which constraints are non‑negotiable from Iron Mountain’s perspective.
...
In this phase Iron Mountain invites DNV to participate as technical advisor in one or more exploratory discussions with TenneT. Together we aim to clarify how queueing and capacity allocation are organised for this connection point, which steps are fixed and where, if anywhere, there is scope to take into account an "interactive consumer" approach or supporting measures on the customer side. A key question is whether and how additional flexibility or grid support from Iron Mountain could influence the handling of the request.
...
If the outcome of Phase 2 is positive, we proceed to outline two to three technical concepts that could help address local constraints or provide additional flexibility. These may include, for example, storage, demand response, reactive power support or other forms of grid support. For each concept we describe the main technical characteristics, the indicative order of magnitude of investment and operating impacts, and the way it could be brought into the dialogue with TenneT.
...
### 6.1 Basis and indicative effort

The work described in this proposal will be carried out on a time‑and‑materials basis. Iron Mountain will be invoiced for the actual hours worked and agreed expenses, using DNV’s standard hourly rates for the staff involved.
...
These figures are indicative only and can be refined once the scope and availability of stakeholders are confirmed.

### 6.2 Hourly rates and invoicing

The following standard rates apply for this assignment (all amounts excl. VAT):

- Senior consultant / project manager: €175 per hour;
- Technical engineer: €150 per hour.

Travel time and reasonable travel expenses for agreed meetings (for example, site visits and meetings with TenneT) will be charged in line with DNV’s standard practice. Invoices will be issued monthly in arrears, based on a summary of hours worked and expenses incurred.
...
DNV is an independent technical advisor and is not part of the decision‑making process at TenneT or Liander. Final decisions on connection capacity, timing and conditions rest solely with the system operators and the relevant authorities. Our role in this project is to help Iron Mountain prepare a transparent, technically underpinned proposal and to clarify the implications of different options.
